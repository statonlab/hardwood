   ...
   <?php if ($main_menu || $secondary_menu): ?>
    <nav id="navigation" class="main-header navbar navbar-light bg-faded navbar-sticky-top">
     <div class="container">
      ...
      <button class="navbar-toggler hidden-lg-up float-xs-right" type="button" data-toggle="collapse" data-target="#navbar-collapse" aria-controls="navbar-collapse" aria-expanded="false" aria-label="Toggle navigation">
       &nbsp;</button>
